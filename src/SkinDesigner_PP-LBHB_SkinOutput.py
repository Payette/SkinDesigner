...
ghenv.Component.Name = "SkinDesigner_PP-LBHB_SkinOutput"
ghenv.Component.NickName = 'PP-LBHB_SkinOutput'
...
class PP_LadybugFunction:
    ...
    def __init__(self):
        ...
        self.__m_functionCall = "LBHB_SkinOutput(SkinPanel_List,"+str(self.__m_WindowStep)+")"
    ...
    def LBHB_SkinOutput(self, SkinPanel_List, stepNumber):
        ...
        sc.sticky["PostProc_Data"].append([self.RunString(), lbGlassSet | lbMullionSet | lbShadingSet | lbWallSet])
        sc.sticky["PostProc_Data"]
        return [self.RunString(), LadybugBrepLists]
